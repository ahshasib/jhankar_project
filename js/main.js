// const milstonsData = JSON.parse(data).data;

// function milestonefun(){

//     let milestones = document.querySelector(".milestones");
//     milestones.innerHTML = `${milstonsData.map(function(mileston){
...
//         ${mileston.modules.map(function(module){
